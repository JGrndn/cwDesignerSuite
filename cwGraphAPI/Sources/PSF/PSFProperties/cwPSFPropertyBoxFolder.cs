...
{
    /// <summary>
    /// Allow to select a folder with a browse button
    /// </summary>
    public class cwPSFPropertyBoxFolder : cwPSFPropertyBox
    {       
        ...
        /// </summary>
        public cwPSFPropertyBoxFolder(String _helpName, String _helpDescription, String _keyName)
        ...
        public void browse_Click(object sender, EventArgs e)
        {
            ...
            fbd.Description = "Choissisez votre répertoire";
            fbd.SelectedPath = this.getValue();
